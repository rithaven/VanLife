  ...
  return (
    <div className="gap-4 p-16 hover:shadow-2xl hover:shadow-white">
      ...
      <div className="grid items-center grid-cols-2 gap-4 p-4 lg:flex mb-14">
        <button className="bg-[#ffead0] rounded-lg p-4 hover:bg-[#e17654]">
          Simple
        </button>
        <button className="bg-[#ffead0] rounded-lg p-4 hover:bg-[#161616] hover:text-white">
          Luxury
        </button>
        <button className="bg-[#ffead0] rounded-lg p-4 hover:bg-[#115e59] hover:text-white">
          Rugged
        </button>
        <p className="underline">Clear filters</p>
      </div>
      <div className="grid gap-8 lg:grid-cols-3">{VanDetails}</div>
    </div>
  );
}
